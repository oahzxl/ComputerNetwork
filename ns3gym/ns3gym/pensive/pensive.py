...
def main():
    ...
    print("Cumulative reward : ", ep_cumulative_reward, " Time : ", time.time() - ep_start_time,
          " Cumulative rebuffer : ", ep_cumulative_rebuffer)
...
def create_animation(args):
    os.chdir("animation")
    os.system("ffmpeg -framerate 8 -pattern_type glob -i '*.png' -c:v libx264 -r 30 -pix_fmt yuv420p " +
              args.animate + ".mp4")
